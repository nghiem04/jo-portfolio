    ...
    stages: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            heading: 'Reflection',
            body: `The most significant decision in this project was choosing to remove the task list rather than improve it. That decision was not reached through ideation. It was reached through synthesis. The interviews established that the list was not an imperfect solution to the problem. For users with ADHD, it was part of the problem. Designing around that finding required accepting that the standard model for this tool category was not the right starting point.<br><br>The conversational model that replaced it was a structural choice grounded in a specific property of conversation: it does not present options and wait. It guides. That was exactly what research had identified as missing. The alignment between the finding and the solution was not coincidental. It was the product of synthesis taken seriously.<br><br>The primary limitation of the project was the absence of longitudinal testing. Three moderated sessions during a hackathon can validate whether users understand the interface and find it less cognitively demanding than alternatives. They cannot establish whether the approach sustains behaviour change over days or weeks, which is the more meaningful measure for a tool designed to support ADHD task management. That remains the logical next step.`,
          },
        ],
      },
    ],
